    ...
    $key  = substr(number_format(time() * rand(), 0, '', ''), 0, 6);
      ...
      if($check_code == NULL) {
        ...
        if($insert_code) {
          ...
          <p>You can change your password by just clicking it <a href="http://localhost/PROJECT%208.%20POSTING%20SITE/admin_changepassword2.php?admin_Id='.$admin_Id.'&&email='.$email.'&&key='.$code.'">here!</a></p> 
...
?>
        ...
        <div class="card-body">
          ...
          <form action="admin_changepassword.php" method="POST">
            ...
            <a href="sendcode2.php?admin_email=<?php echo $email; ?>" class="mt-1">Didn't get a code?</a>
            <hr>
